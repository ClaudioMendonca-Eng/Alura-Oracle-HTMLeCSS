...
Retornando à documentação do HTML, utilizamos as tags essenciais para definir a estrutura do HTML5. A meta informação title foi seguida pela abertura e fechamento da tag <code><body></code>, que representa o corpo visível da página.

Dentro do corpo, adicionamos um título <code><h1></code> com o texto "Isso é um título" e um parágrafo <code><p></code> com o texto "Isso é um parágrafo". Para dar mais contexto à página, inserimos uma imagem <code><img></code> com a tag de atributo src apontando para a imagem "html.png". Além disso, adicionamos a propriedade alt para fornecer um texto alternativo, melhorando a acessibilidade.
